CreditsController_ctor:
	STMFD 	SP!, {R4,LR}
	MOV		R0, #0x1000
	BL		allocFromGameHeap
	MOVS	R4, R0
	BEQ		CreditsController_ctor_end
	BL		EnemyActor_ctor
	LDR		R0, =CreditsController_vtable
	STR		R0, [R4]
	
CreditsController_ctor_end:
	MOV		R0, R4
	LDMFD 	SP!, {R4,PC}

CreditsController_OnCreate:
	STMFD	SP!, {R4,LR}
	MOV		R4, R0
	...
	BLX 	R3
	MOV		R0, R4
	BL 		CreditsController_setup
	MOV 	R0, #1
	LDMFD 	SP!, {R4,PC}	
	
	
CreditsController_Profile:
	.long CreditsController_ctor
	.long 0x1460146
	.long CreditsController_loadFiles
	.long 0x0
	.long 0x0

CreditsController_vtable:
	.long CreditsController_OnCreate
	...
	.long CreditsController_dtor
	.long CreditsController_dtorFree
	.long actor_getSomething
	.long actor_incrementSomething
	.long CreditsController_ExecuteCommand
	.long 0x0209AD1C
