BowserHeadEntrance_ctor:
	STMFD 	SP!, {R4,LR}
	MOV		R0, #0x430
	BL		allocFromGameHeap
	MOVS	R4, R0
	BEQ		BowserHeadEntrance_ctor_end
	BL		EnemyActor_ctor
	LDR		R0, =BowserHeadEntrance_vtable
	STR		R0, [R4]
	
BowserHeadEntrance_ctor_end:
	MOV		R0, R4
	LDMFD 	SP!, {R4,PC}

BowserHeadEntrance_OnCreate:
	STMFD	SP!, {R4,LR}
	MOV		R4, R0
	...
	BLX 	R3
	MOV		R0, R4
	BL 		BowserHeadEntrance_setup
	MOV 	R0, #1
	LDMFD 	SP!, {R4,PC}	

BowserHeadEntrance_Profile:
	.long BowserHeadEntrance_ctor
	.long 0x144012B
	.long BowserHeadEntrance_loadFiles

BowserHeadEntrance_vtable:
	.long BowserHeadEntrance_OnCreate
	...
	.long BowserHeadEntrance_dtor
	.long BowserHeadEntrance_dtorFree
	.long actor_getSomething
	.long actor_incrementSomething
	.long BowserHeadEntrance_IdleState
	.long 0x0209AD1C
	.long BowserHeadEntrance_StateEntered
