...
void MinecartEnemy_StateIdle(MinecartEnemy* cart);
void MinecartEnemy_StateFalling(MinecartEnemy* cart);
void MinecartEnemy_StateLanding(MinecartEnemy* cart);
void MinecartEnemy_StateDead(MinecartEnemy* cart);
