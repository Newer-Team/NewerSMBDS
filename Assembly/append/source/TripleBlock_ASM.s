Tripleblock_ctor:
    ...
    MOVS    R4, R0
    BEQ     Tripleblock_ctor_end
    BL      EnemyActor_ctor
    LDR     R0, =Tripleblock_vtable
    STR     R0, [R4]
    
Tripleblock_ctor_end:
    MOV     R0, R4
    LDMFD   SP!, {R4,PC}

Tripleblock_OnCreate:
    STMFD   SP!, {R4,LR}
    MOV     R4, R0
...
Tripleblock_Profile:
    .long Tripleblock_ctor
    .long 0x144012B
    .long Tripleblock_loadFiles
    .long 0x0
    .long 0x0

Tripleblock_vtable:
    .long Tripleblock_OnCreate
    .long actor_beforeCreate
    .long actor_afterCreate
    .long Tripleblock_delete
    ...
    .long Tripleblock_dtor
    .long Tripleblock_dtorFree
    .long actor_getSomething
    .long actor_incrementSomething
    .long Tripleblock_IdleState
    .long 0x0209AD1C
    .long Tripleblock_StateBeingHit
