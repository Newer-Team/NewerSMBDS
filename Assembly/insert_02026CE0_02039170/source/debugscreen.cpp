...
{	
	...
	if (currentScene == 0)
	{
		nds_printf(something, *topScreenPtr+64,  "Whoops! NewerDS v" GAME_VERSION "-EN crashed");
	...
	{		
		...
		nds_printf(something, *topScreenPtr + 33, "NewerDS " GAME_VERSION " RAM Viewer", ptr);
	...
	{
		nds_printf(something, *topScreenPtr+288, "      NewerDS v" GAME_VERSION " crashed     ");
