MovementController_ctor:
	STMFD 	SP!, {R4,LR}
	MOV		R0, #0x6B0
	BL		allocFromGameHeap
	MOVS	R4, R0
	BEQ		MovementController_ctor_end
	BL		EnemyActor_ctor
	LDR		R0, =MovementController_vtable
	STR		R0, [R4]

MovementController_ctor_end:
	MOV		R0, R4
	LDMFD 	SP!, {R4,PC}

MovementController_OnCreate:
	STMFD	SP!, {R4,LR}
	MOV		R4, R0
	...
	BLX 	R3
	MOV		R0, R4
	BL 		MovementController_setup
	MOV 	R0, #1
	LDMFD 	SP!, {R4,PC}	

MovementController_vtable:
	.long MovementController_OnCreate
	...
	.long MovementController_update_state0
	.long 0x0209AD1C
