ExtraPrize_ctor:
	...
	MOVS	R4, R0
	BEQ		ExtraPrize_ctor_end
	BL		EnemyActor_ctor
	LDR		R0, =ExtraPrize_vtable
	STR		R0, [R4]
...
ExtraPrize_Profile:
	.long ExtraPrize_ctor
	.short 0x14D
	.short 0x14D
	.long ExtraPrize_loadFiles
	

ExtraPrize_vtable:
	.long ExtraPrize_OnCreate
	...
	.long ExtraPrize_draw
	.long ExtraPrize_beforeDraw
	...
	.long ExtraPrize_IdleState
	.long 0x0209AD1C
	.long ExtraPrize_StateCollected
	...
	.long ExtraPrizeKoopaCollision			@ called when recieving a koopa shell (EnemyActor__virt42: 0x0209D920)
