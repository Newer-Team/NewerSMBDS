BowserFire_ctor:
	...
	MOVS 	R4, R0
	BEQ 	BowserFire_ctor_end
	BL 		EnemyActor_ctor
	LDR 	R0, =BowserFire_vtable
	STR 	R0, [R4]
BowserFire_ctor_end:
	MOV		R0, R4
	LDMFD 	SP!, {R4,PC}
...
BowserFire_Profile:
	.long  BowserFire_ctor
	.short 0x14C
	.short 0x14C
	.long  BowserFire_loadFiles

BowserFire_vtable:
	.long BowserFire_onCreate
	...
	.long BowserFire_draw
	.long BowserFire_beforeDraw
	...
	.long BowserFire_null			@ called when hit from below block (EnemyActor__virt41: 0x0209D988)	
	.long BowserFire_null			@ called when recieving a koopa shell (EnemyActor__virt42: 0x0209D920)
	.long BowserFire_null			@ called when recieving a fireball (EnemyActor__virt43: 0x0209D84C)
	.long 0x0209D568			@ unknow callback
	.long 0x0209D43C			@ unknown callback
	.long BowserFire_null			@ called when killed by Mega Mario (EnemyActor__virt47: 0x0209D158)
	.long 0x0209D158			@ unknown callback
	.long 0x0209D014			@ unknown callback
	.long BowserFire_null
	.long 0x0209CE08			@ called when beeing ground-pounded
	.long BowserFire_null		 	@ called when hit by Shell Mario (EnemyActor__virt51: 0x0209CBF8)
	.long 0x0209CAD0			@ unknown callback
	.long 0x02098F7C			@ unknown callback
	.long BowserFire_null			@ called when player touches flagpole (EnemyActor__DieFromFlagpole: 0x02098E7C)
	.long 0x0209CD3C			@
	.long 0x0209CAC4			@
	.long BowserFire_null
	.long 0x02099168			@ called when colliding with player?
	.long BowserFire_CollisionSomething	@ called when colliding with player. Returns weather to hurt Mario (0) or to pass trough (1). The function can kill the sprite as well.
	.long BowserFire_null			@ called when sprite killed by bottom/block?
	.long 0x02098A10
