AppearTiles_ctor:
	...
	MOVS	R4, R0
	BEQ		AppearTiles_ctor_end
	BL		EnemyActor_ctor
	LDR		R0, =AppearTiles_vtable
	STR		R0, [R4]
	
AppearTiles_ctor_end:
	MOV		R0, R4
	LDMFD 	SP!, {R4,PC}

AppearTiles_OnCreate:
	STMFD	SP!, {R4,LR}
	MOV		R4, R0
	...
	BLX 	R3
	MOV		R0, R4
	BL 		AppearTiles_setup
	MOV 	R0, #1
	LDMFD 	SP!, {R4,PC}	

AppearTiles_Profile:
	.long AppearTiles_ctor
	.long 0x144012B
	.long AppearTiles_loadFiles

AppearTiles_vtable:
	.long AppearTiles_OnCreate
	...
	.long AppearTiles_dtor
	.long AppearTiles_dtorFree
	.long actor_getSomething
	.long actor_incrementSomething
	.long AppearTiles_IdleState
	.long 0x0209AD1C
