...
PlayerSpell_ctor:
	...
	MOVS	R4, R0
	BEQ 	PlayerSpell_ctor_end
	BL 		EnemyActor_ctor
	LDR 	R0, =PlayerSpell_vtable
	STR 	R0, [r4]
PlayerSpell_ctor_end:
	MOV		R0, R4
	LDMFD 	SP!, {R4,PC}
	
PlayerSpell_onCreate:
	STMFD 	SP!, {R4,LR}
	MOV    	R4, R0
	...
	BLX 	R3
	MOV	 	R0, R4
	BL 		PlayerSpell_setup
	MOV		R0, #1
	LDMFD 	SP!, {R4, PC}

PlayerSpell_Profile:
	.long PlayerSpell_ctor
	.long 0x144012B
	.long 0x0
	.long 0x0
	.long 0x0
...
PlayerSpell_vtable:
	...
	.long PlayerSpell_State0
	.long 0x0209AD1C
	.long PlayerSpell_State1
	...
	.long 0x0209CAD0
	.long 0x02098F7C
	.long PlayerSpell_DieOnFlagpole	@ 0x02098E7C
