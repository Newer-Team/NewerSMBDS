...
void FlipBlock_SetBlockStateHit(FlipBlock* trpl);
void FlipBlock_CheckIfMarioGP(FlipBlock* trpl, MarioActor* Player);
void FlipBlock_CheckIfMario(FlipBlock* trpl, MarioActor* Player);
void FlipBlock_CheckIfShell(FlipBlock* trpl, EnemyClassObject* Enemy);
void FlipBlock_StateBeingHit(FlipBlock* trpl);
void FlipBlock_MakeCollisions(FlipBlock* trpl);
void FlipBlock_Megashroom(FlipBlock* trpl);
bool FlipBlock_CheckIfMarioIsInRange(FlipBlock* trpl);
